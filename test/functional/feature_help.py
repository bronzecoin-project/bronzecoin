...
"""Verify that starting bronzecoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bronzecoin with -h for help text")
        ...
        self.log.info("Start bronzecoin with -version for version information")
        ...
        self.log.info("Start bronzecoind with -fakearg to make sure it does not start")
