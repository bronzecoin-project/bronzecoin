Contributing to Bronzecoin Core
============================

The Bronzecoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Bronzecoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/bronzecoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to bronzecoin-qt
...
The following applies to code changes to the Bronzecoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Bronzecoin
Network Protocol consensus changes.

Whether a pull request is merged into Bronzecoin Core rests with the project merge
...
Patches that change Bronzecoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Bronzecoin consensus, it must have been
...
The project leader is the release manager for each Bronzecoin Core release.
