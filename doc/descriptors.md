# Support for Output Descriptors in Bronzecoin Core

Since Bronzecoin Core v0.17, there is support for Output Descriptors. This is a
...
existing Bronzecoin Core wallets, a convenience function `combo` is
