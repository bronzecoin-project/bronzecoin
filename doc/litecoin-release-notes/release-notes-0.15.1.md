Bronzecoin Core version *0.15.1* is now available from:

  <https://download.bronzecoin.org/bronzecoin-0.15.1/>
...
A number of changes to the way Bronzecoin Core deals with peer connections and invalid blocks
