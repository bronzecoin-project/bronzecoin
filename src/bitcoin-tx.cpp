...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bronzecoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  bronzecoin-tx [options] <hex-tx> [commands]  Update hex-encoded bronzecoin transaction\n" +
            "or:     bronzecoin-tx [options] -create [commands]   Create hex-encoded bronzecoin transaction\n" +
            "\n";
