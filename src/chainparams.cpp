...
{
    const char* pszTimestamp = "BronzeCoinDev 2023";
    const CScript genesisOutputScript = CScript() << ParseHex("202311230fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1700725086, 2000571475, 0x1e0ffff0, 1, 86 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xf5127ec9d1a14a448ba8489a399acf9ee7753c87e1e98938bf1184949bd77cb2"));
        assert(genesis.hashMerkleRoot == uint256S("0xdc75a7fe257d2a8318204e47e19ac3720de38feacc58df87407960051db290ea"));
        ...
        vSeeds.emplace_back("52.16.16.170");
        // vSeeds.emplace_back("dnsseed.thrasher.io");
        // vSeeds.emplace_back("dnsseed.bronzecointools.com");
        // vSeeds.emplace_back("dnsseed.bronzecoinpool.org");
        ...
        checkpointData = {
            {
                {  0, uint256S("0xf5127ec9d1a14a448ba8489a399acf9ee7753c87e1e98938bf1184949bd77cb2")},
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1700725086, 2308549, 0x1e0ffff0, 1, 86 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xcbf737283e41dc1d90d8ef84ee6871ab19eda23640502e7455930884873854c0"));
        assert(genesis.hashMerkleRoot == uint256S("0xdc75a7fe257d2a8318204e47e19ac3720de38feacc58df87407960051db290ea"));
        ...
        vSeeds.emplace_back("52.16.16.170");
        // vSeeds.emplace_back("seed-b.bronzecoin.loshan.co.uk");
        ...
        checkpointData = {
            {
                {0, uint256S("0xcbf737283e41dc1d90d8ef84ee6871ab19eda23640502e7455930884873854c0")},
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1700725086, 1, 0x207fffff, 1, 86 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xbdfa1259bff4a0bdd8baf11cf711dbd91e335ae80d9c172141a630e4d224273e"));
        assert(genesis.hashMerkleRoot == uint256S("0xdc75a7fe257d2a8318204e47e19ac3720de38feacc58df87407960051db290ea"));
